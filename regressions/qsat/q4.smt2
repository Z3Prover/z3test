...
(assert (forall ((x Int)) (exists ((y Int)) (and (<= (* 2 y) x) (< x (* 2 (+ y 1))))))) (apply qe2) (reset)


(assert (exists ((x Int) (y Int)) (and (> y 0) (> y (* 2 x)) (< y (+ x 2)) (= 0 (mod y 2))))) (apply qe2) (reset)

(assert (exists ((x Int)) (and (< (* 3 x) 3) (< 1 (* 2 x))))) (apply qe2) (reset)


(assert  (exists ((x Int)) (and (< (* 3 x) 4) (< 1 (* 2 x))))) (apply qe2) (reset)

(assert (exists ((x Int)) (and (< (+ (* 3 x) 1) 10) (> (- (* 7 x) 6) 7) (= 0 (mod x 3))))) (apply qe2) (reset)


(assert (exists ((x Int) (y Int)) (and (< (- 1 (* 5 y)) x) (< (+ 1 y) (* 13 x)) (< (+ x 2) 0) (> y 0)))) (apply qe2) (reset)    
    
(assert (exists ((x Int) (y Int)) (and (< (- 1 (* 5 y)) x) (< (+ 1 y) (* 13 x)) (< x -2)))) (apply qe2) (reset)
    
(assert (exists ((w Int) (z Int) (y Int) (x Int)) (and (< (- 1 (* 5 y)) (+ x (* 2 z))) (< (+ 1 y w (* -4 z)) (* 13 x)) (< x -2) (> z 0)))) (apply qe2) (reset)
...
(assert 
                 (forall ((w Int))
                   (exists ((z Int) (y Int) (x Int))
                     (and (< (- 1 (* 5 y)) (+ x (* 2 z))) 
                          (< (- (+ 1 y) (* 4 z)) (* 13 x)) 
                          (< x -2) (> z 0) (< x 10))))     ) (apply qe2) (reset)
    
    
(assert 
                 (forall ((d Int) (c Int) (b Int))
                      (and (= c 0) (= d (* b c)) (= d 4)))) (apply qe2) (reset)

(assert
                 (exists ((d Int) (c Int) (b Int))
                      (and (= c 0) (= d (* b c)) (= d 0)))) (apply qe2) (reset)
...
(assert (forall ((x Int) (y Int)) (not (= (+ 1 (* 2 x)) (* 2 y))))) (apply qe2) (reset)


(assert (exists ((x Int) (y Int)) (= 1 (- (* 4 x) (* 6 y))))) (apply qe2) (reset)





(assert (forall ((d Int)) (=> (>= d 0) (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= d (+ (* 3 x) (* 5 y)))))))) (apply qe2) (reset)

(assert  (forall ((d Int)) (=> true     (exists ((x Int) (y Int)) (and true     true     (= d (+ (* 3 x) (* 5 y)))))))) (apply qe2) (reset)

(assert  (forall ((d Int)) (=> (>= d 8) (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= d (+ (* 3 x) (* 5 y)))))))) (apply qe2) (reset)

(assert (forall ((d Int)) (=> (>= d 0) (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= d (- (* 3 x) (* 5 y)))))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int)) (and (> x 0) (>= y 0) (= 1 (- (* 3 x) (* 5 y)))))) (apply qe2) (reset)
    
(assert (exists ((x Int) (y Int) (z Int)) (= 1 (- (* 4 x) (* 6 y))))) (apply qe2) (reset)


(assert (forall ((x Int) (y Int)) (=> (<= x y) (< (+ 1 (* 2 x)) (* 2 y))))) (apply qe2) (reset)

    
(assert (forall ((x Int) (y Int) (z Int)) (=> (= (+ 1 (* 2 x)) (* 2 y)) (> (+ x y z) 129)))) (apply qe2) (reset)
    

(assert (forall ((a Int)) (exists ((b Int)) (or (< a (+ (* 4 b) (* 3 a))) (and (not (< a b)) (> a (+ b 1))))))) (apply qe2) (reset)

(assert (exists ((y Int)) (forall ((x Int)) (and (> (+ x (* 5 y)) 1) (> (- (* 13 x) y) 1) (< (+ x 2) 0))))) (apply qe2) (reset)


(assert (forall ((x Int) (y Int)) (=> (and (>= x 0) (>= y 0)) (or (< (- (* 12 x) (* 8 y)) 0) (> (- (* 12 x) (* 8 y)) 2))))) (apply qe2) (reset)


(assert (exists ((x Int) (y Int)) (= 1 (+ (* 5 x) (* 10 y))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= 1 (- (* 5 x) (* 6 y)))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int) (z Int) (w Int)) (= 1 (+ (* 2 w) (* 3 x) (* 4 y) (* 5 z))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= 1 (- (* 5 x) (* 3 y)))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= 1 (- (* 3 x) (* 5 y)))))) (apply qe2) (reset)

(assert (exists ((x Int) (y Int)) (and (>= x 0) (>= y 0) (= 1 (- (* 6 x) (* 3 y)))))) (apply qe2) (reset)

(assert (forall ((x Int) (y Int)) (or (= 0 (mod x 5)) (= 0 (mod y 6)) (not (= (* 6 x) (* 5 y)))))) (apply qe2) (reset)


(assert (forall ((x Int) (y Int)) (or                                (not (= (* 6 x) (* 5 y)))))) (apply qe2) (reset)
...
(assert 
                 (forall ((x Int))
                   (iff (and (not (exists ((m Int)) (= x (* 2 m)))) (exists ((m Int)) (= x (+ (* 3 m) 1)))) 
                        (or  (exists ((m Int)) (= x (+ (* 12 m) 1))) (exists ((m Int)) (= x (+ (* 12 m) 7))))))) (apply qe2) (reset)
...
(assert 
                 (forall ((a Int) (b Int) (x Int) (y Int) (z Int))
                   (=> (and (= (+ a 2) b) (= x (+ 1 (- b a))) (= y (- b 2)) (= z 3)) false))) (apply qe2) (reset)

(assert 
                 (exists ((a Int) (b Int)) 
                   (and (not (= a 1)) (= a b) (or (= a (* 2 b)) (= (* 2 b) (+ 1 (* 3 a))))))) (apply qe2) (reset)


(assert 
                 (exists ((a Int) (b Int)) 
                   (and (> a 1) (> b 1) (= a b) (or (= a (* 2 b)) (= (* 2 b) (+ 1 (* 3 a))))))) (apply qe2) (reset)

(assert 
                 (exists ((a Int) (b Int)) 
                   (and (> a 1) (> b 1)  
                     (or (= a (* 2 b)) (= (* 2 b) (+ 1 (* 3 a)))) 
                     (or (= b (* 2 a)) (= (* 2 a) (+ 1 (* 3 b))))))) (apply qe2) (reset)


(assert 
                 (forall ((x Int))(=> (>= x 8) 
                        (exists ((u Int) (v Int)) (and (>= u 0) (>= v 0) (= x (+ (* 3 u) (* 5 v)))))))) (apply qe2) (reset)
...
(assert 
                 (exists ((l Int))(forall ((x Int))(=> (>= x l) 
                        (exists ((u Int) (v Int)) (and (>= u 0) (>= v 0) (= x (+ (* 3 u) (* 7 v))))))))) (apply qe2) (reset)

(assert 
                 (exists ((l Int))(forall ((x Int))(=> (>= x l) 
                        (exists ((u Int) (v Int)) (and (>= u 0) (>= v 0) (= x (+ (* 3 u) (* 8 v))))))))) (apply qe2) (reset)
                 ...
                 (forall ((n Int))
                  (=> (and (< 0 n) (< n 2400)) 
                      (or (and (<= n 2) (<= 2 (* 2 n))) 
                          ...
                          (and (<= n 631) (<= 631 (* 2 n))) 
                          (and (<= n 1259) (<= 1259 (* 2 n))) 
                          (and (<= n 2503) (<= 2503 (* 2 n))))))) (apply qe2) (reset)
