...
(assert (= (* 90.0 step_4_alpha) (* 100.0 value_alpha_3)))
...
(assert (= (* 1.6 step_4_a) (* (/ 3.14159 180.0) (* 90.0 step_4_alpha))))
(assert (< (* 5.0 step_4_e.dx) 1003.90625))
(assert (= 1.0 step_4_s0.q_a))
(assert (>= step_4_s1.q_i (- 1.0)))
(assert (<= (- 1.0) step_4_e.q_k))
(assert (<= (* 1000.0 step_4_s0.dy) 1000.0))
(assert (<= (* 90.0 step_4_alpha) 90.0))
...
(assert (>= (* 5.0 step_4_e.dy) 160.0))
(assert (<= (* 5.0 step_4_e.dx) 440.0))
(assert (<= (* 5.0 step_4_e.dy) 170.0))
(assert (>= (* 5.0 step_3_e.dx) 430.0))
(assert (>= (* 5.0 step_3_e.dy) 53.33333333333334))
(assert (<= (* 5.0 step_3_e.dx) 440.0))
(assert (<= (* 5.0 step_3_e.dy) 63.33333333333334))
(assert (>= (* 5.0 step_2_e.dx) 430.0))
(assert (>= (* 5.0 step_2_e.dy) (- 53.33333333333333)))
(assert (<= (* 5.0 step_2_e.dx) 440.0))
(assert (<= (* 5.0 step_2_e.dy) (- 43.33333333333333)))
