...
(assert (= step_4_s1.q_k step_4_e.q_k))
...
(assert (= step_4_s1.q_a step_4_e.q_a))
...
(assert (> (* 5.0 step_4_e.dy) (- 1003.90625)))
...
(assert (= (* 1.6 step_4_a) (* (/ 3.14159 180.0) (* 1.0E-6 step_4_alpha))))
(assert (< (* 5.0 step_4_e.dx) 1003.90625))
(assert (= 1.0 step_4_s0.q_a))
(assert (>= step_4_s1.q_i (- 1.0)))
(assert (<= (- 1.0) step_4_e.q_k))
(assert (<= (* 1000.0 step_4_s0.dy) 1000.0))
(assert (<= (* 1.0E-6 step_4_alpha) 90.0))
...
(assert (= (* 2.0 (* 1.0E-6 length2) step_4_s1.q_a step_4_s1.q_k) (* 5.0 step_4_e.dy)))
(assert (<= (* 5.0 step_4_e.dy) 1000.0))
(assert (>= (* 1000.0 step_4_s0.dx) (- 1000.0)))
(assert (= (+ (* 1000.0 step_4_s1.dx) (* (- 1.0) (* (* 1.0E-6 length2) (^ step_4_s1.q_k 2.0))) (* (* 1.0E-6 length2) (^ step_4_s1.q_a 2.0))) (* 5.0 step_4_e.dx)))
(assert (> (* 1000.0 step_4_s0.dx) (- 1003.90625)))
(assert (<= (* 1000.0 step_4_e.dz) 1000.0))
(assert (>= step_4_s1.q_j (- 1.0)))
...
(assert (= (* 1.6 step_5_a) (* (/ 3.14159 180.0) (* 90.0 step_5_alpha))))
...
(assert (= (* 1.0E-6 length1) (* 1000.0 step_5_s1.dx)))
...
(assert (= step_5_s1.q_k step_5_e.q_k))
(assert (= 1.0 step_5_s0.q_a))
(assert (<= step_5_s1.q_j 1.0))
...
(assert (<= (* 1000.0 step_5_e.dz) 1000.0))
(assert (= (+ (* 1000.0 step_5_s1.dx) (* (- 1.0) (* (* 1.0E-6 length2) (^ step_5_s1.q_k 2.0))) (* (* 1.0E-6 length2) (^ step_5_s1.q_a 2.0))) (* 5.0 step_5_e.dx)))
(assert (>= step_5_s1.q_a (- 1.0)))
(assert (<= (* 1000.0 step_5_s1.dx) 1000.0))
(assert (= (* 2.0 (* 1.0E-6 length2) step_5_s1.q_a step_5_s1.q_k) (* 5.0 step_5_e.dy)))
(assert (>= step_5_e.q_j (- 1.0)))
...
(assert (<= (* 1.0E-6 step_3_alpha) 90.0))
...
(assert (>= (* 5.0 step_3_e.dy) 0.0))
(assert (<= (* 5.0 step_3_e.dx) 440.0))
(assert (<= (* 5.0 step_3_e.dy) 10.0))
(assert (>= (* 5.0 step_1_e.dx) 430.0))
(assert (>= (* 5.0 step_1_e.dy) (- 160.0)))
(assert (<= (* 5.0 step_1_e.dx) 440.0))
(assert (<= (* 5.0 step_1_e.dy) (- 150.0)))
(assert (>= (* 5.0 step_4_e.dx) 430.0))
(assert (>= (* 5.0 step_4_e.dy) 79.99999999999999))
(assert (<= (* 5.0 step_4_e.dx) 440.0))
(assert (<= (* 5.0 step_4_e.dy) 89.99999999999999))
(assert (>= (* 5.0 step_2_e.dx) 430.0))
(assert (>= (* 5.0 step_2_e.dy) (- 80.0)))
(assert (<= (* 5.0 step_2_e.dx) 440.0))
(assert (<= (* 5.0 step_2_e.dy) (- 70.0)))
(assert (>= (* 5.0 step_5_e.dx) 430.0))
(assert (>= (* 5.0 step_5_e.dy) 160.0))
(assert (<= (* 5.0 step_5_e.dx) 440.0))
(assert (<= (* 5.0 step_5_e.dy) 170.0))
(check-sat)
(exit)
