...
(assert (forall ((@u0 Fuel) (@x1 Term) (@base Term) (@f (=> Term Bool)))
  (! (iff (HasTypeFuel @u0 @x1 (Tm_refinement @base @f))
          (and (HasTypeFuel @u0 @x1 @base) (select @f @x1)))
     :pattern ((HasTypeFuel @u0 @x1 (Tm_refinement @base @f)))
     :qid refine_interp_ho_fuel)))
...
(assert (! (forall ((@x1 Term)) (! (iff (select Tm_refine_pred_0766302b68bb44ab7aff8c4d8be0b46f @x1) (not (= @x1 (BoxInt 0)))) :pattern ((select Tm_refine_pred_0766302b68bb44ab7aff8c4d8be0b46f @x1)) :qid ho_refinement_interpretation_Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f_sel)) :named ho_refinement_interpretation_Tm_refine_0766302b68bb44ab7aff8c4d8be0b46f_sel))


(assert (! (forall ((@x1 Term) (@u2 Universe) (@x3 Term)) (! (iff (select (Tm_refine_pred_0ce91af3d6762ea7d913b870f9e33a01 @u2 @x3) @x1) (= (FStar.Seq.Base.length @u2 @x3 @x1) (BoxInt 0))) :pattern ((select (Tm_refine_pred_0ce91af3d6762ea7d913b870f9e33a01 @u2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_0ce91af3d6762ea7d913b870f9e33a01_sel)) :named ho_refinement_interpretation_Tm_refine_0ce91af3d6762ea7d913b870f9e33a01_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_0ea1fba779ad5718e28476faeef94d56 @x2) @x1) (= (FStar.UInt32.v @x1) @x2)) :pattern ((select (Tm_refine_pred_0ea1fba779ad5718e28476faeef94d56 @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_0ea1fba779ad5718e28476faeef94d56_sel)) :named ho_refinement_interpretation_Tm_refine_0ea1fba779ad5718e28476faeef94d56_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_150c87740acaa31f788a9e84dd5820c2 @x2) @x1) (= (FStar.Seq.Base.length U_zero Prims.bool @x1) @x2)) :pattern ((select (Tm_refine_pred_150c87740acaa31f788a9e84dd5820c2 @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_150c87740acaa31f788a9e84dd5820c2_sel)) :named ho_refinement_interpretation_Tm_refine_150c87740acaa31f788a9e84dd5820c2_sel))


(assert (! (forall ((@x1 Term) (@u2 Universe) (@x3 Term) (@x4 Term)) (! (iff (select (Tm_refine_pred_160fe7faad9a466b3cae8455bac5be60 @u2 @x3 @x4) @x1) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 (FStar.Seq.Base.length @u2 @x3 @x4)))) :pattern ((select (Tm_refine_pred_160fe7faad9a466b3cae8455bac5be60 @u2 @x3 @x4) @x1)) :qid ho_refinement_interpretation_Tm_refine_160fe7faad9a466b3cae8455bac5be60_sel)) :named ho_refinement_interpretation_Tm_refine_160fe7faad9a466b3cae8455bac5be60_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_2b25e5c3b25bc06167200cbfa5d36b3e @x2 @x3) @x1) (= (FStar.UInt.logxor (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_2b25e5c3b25bc06167200cbfa5d36b3e @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_2b25e5c3b25bc06167200cbfa5d36b3e_sel)) :named ho_refinement_interpretation_Tm_refine_2b25e5c3b25bc06167200cbfa5d36b3e_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_34425c23b534b8a294f8f063dd9faa4b @x2 @x3) @x1) (BoxBool_proj_0 (Prims.op_LessThan @x1 @x2))) :pattern ((select (Tm_refine_pred_34425c23b534b8a294f8f063dd9faa4b @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_34425c23b534b8a294f8f063dd9faa4b_sel)) :named ho_refinement_interpretation_Tm_refine_34425c23b534b8a294f8f063dd9faa4b_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_35a0739c434508f48d0bb1d5cd5df9e8 @x2 @x3) @x1) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 (Prims.op_Subtraction @x2 @x3)))) :pattern ((select (Tm_refine_pred_35a0739c434508f48d0bb1d5cd5df9e8 @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_35a0739c434508f48d0bb1d5cd5df9e8_sel)) :named ho_refinement_interpretation_Tm_refine_35a0739c434508f48d0bb1d5cd5df9e8_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_39cb18a1d289e559096741772432b24f @x2 @x3) @x1) (= (FStar.UInt.logor (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_39cb18a1d289e559096741772432b24f @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_39cb18a1d289e559096741772432b24f_sel)) :named ho_refinement_interpretation_Tm_refine_39cb18a1d289e559096741772432b24f_sel))


(assert (! (forall ((@x1 Term) (@u2 Universe) (@x3 Term) (@x4 Term) (@x5 Term)) (! (iff (select (Tm_refine_pred_444061fd0bd0053c4f27fa233082c9ca @u2 @x3 @x4 @x5) @x1) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 (Prims.op_Addition (FStar.Seq.Base.length @u2 @x3 @x4) (FStar.Seq.Base.length @u2 @x3 @x5))))) :pattern ((select (Tm_refine_pred_444061fd0bd0053c4f27fa233082c9ca @u2 @x3 @x4 @x5) @x1)) :qid ho_refinement_interpretation_Tm_refine_444061fd0bd0053c4f27fa233082c9ca_sel)) :named ho_refinement_interpretation_Tm_refine_444061fd0bd0053c4f27fa233082c9ca_sel))


(assert (! (forall ((@x1 Term)) (! (iff (select Tm_refine_pred_542f9d4f129664613f2483a6c88bc7c2 @x1) (>= (BoxInt_proj_0 @x1) (BoxInt_proj_0 (BoxInt 0)))) :pattern ((select Tm_refine_pred_542f9d4f129664613f2483a6c88bc7c2 @x1)) :qid ho_refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2_sel)) :named ho_refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_59202c8b625f4b04caf2081d6778d9e7 @x2 @x3) @x1) (= (FStar.UInt.shift_right (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_59202c8b625f4b04caf2081d6778d9e7 @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_59202c8b625f4b04caf2081d6778d9e7_sel)) :named ho_refinement_interpretation_Tm_refine_59202c8b625f4b04caf2081d6778d9e7_sel))


(assert (! (forall ((@x1 Term) (@u2 Universe) (@x3 Term) (@x4 Term) (@x5 Term)) (! (iff (select (Tm_refine_pred_5a92b6e4e7af9363bc35e43d9d7f3f13 @u2 @x3 @x4 @x5) @x1) (BoxBool_proj_0 (Prims.op_LessThanOrEqual @x3 @x1))) :pattern ((select (Tm_refine_pred_5a92b6e4e7af9363bc35e43d9d7f3f13 @u2 @x3 @x4 @x5) @x1)) :qid ho_refinement_interpretation_Tm_refine_5a92b6e4e7af9363bc35e43d9d7f3f13_sel)) :named ho_refinement_interpretation_Tm_refine_5a92b6e4e7af9363bc35e43d9d7f3f13_sel))


(assert (! (forall ((@x1 Term)) (! (iff (select Tm_refine_pred_774ba3f728d91ead8ef40be66c9802e5 @x1) (> (BoxInt_proj_0 @x1) (BoxInt_proj_0 (BoxInt 0)))) :pattern ((select Tm_refine_pred_774ba3f728d91ead8ef40be66c9802e5 @x1)) :qid ho_refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5_sel)) :named ho_refinement_interpretation_Tm_refine_774ba3f728d91ead8ef40be66c9802e5_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_7e0b9b2dbca36eab00de093c1b701c6d @x2) @x1) (<= (BoxInt_proj_0 @x1) (BoxInt_proj_0 @x2))) :pattern ((select (Tm_refine_pred_7e0b9b2dbca36eab00de093c1b701c6d @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_7e0b9b2dbca36eab00de093c1b701c6d_sel)) :named ho_refinement_interpretation_Tm_refine_7e0b9b2dbca36eab00de093c1b701c6d_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_9464479a8dbea99c4e6879c5c69f2f30 @x2 @x3) @x1) (Valid @x2)) :pattern ((select (Tm_refine_pred_9464479a8dbea99c4e6879c5c69f2f30 @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_9464479a8dbea99c4e6879c5c69f2f30_sel)) :named ho_refinement_interpretation_Tm_refine_9464479a8dbea99c4e6879c5c69f2f30_sel))


(assert (! (forall ((@x1 Term)) (! (iff (select Tm_refine_pred_9d6af3f3535473623f7aec2f0501897f @x1) (Valid (Prims.hasEq U_zero @x1))) :pattern ((select Tm_refine_pred_9d6af3f3535473623f7aec2f0501897f @x1)) :qid ho_refinement_interpretation_Tm_refine_9d6af3f3535473623f7aec2f0501897f_sel)) :named ho_refinement_interpretation_Tm_refine_9d6af3f3535473623f7aec2f0501897f_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_ace23c600fbe87b65e5fc333816f74de @x2 @x3) @x1) (= (FStar.UInt.sub_mod (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_ace23c600fbe87b65e5fc333816f74de @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_ace23c600fbe87b65e5fc333816f74de_sel)) :named ho_refinement_interpretation_Tm_refine_ace23c600fbe87b65e5fc333816f74de_sel))


(assert (! (forall ((@x1 Term) (@u2 Universe) (@x3 Term) (@x4 Term) (@x5 Term)) (! (iff (select (Tm_refine_pred_b9ca4cf05147d86d6eff56ccafdd09d0 @u2 @x3 @x4 @x5) @x1) (<= (BoxInt_proj_0 @x3) (BoxInt_proj_0 @x1))) :pattern ((select (Tm_refine_pred_b9ca4cf05147d86d6eff56ccafdd09d0 @u2 @x3 @x4 @x5) @x1)) :qid ho_refinement_interpretation_Tm_refine_b9ca4cf05147d86d6eff56ccafdd09d0_sel)) :named ho_refinement_interpretation_Tm_refine_b9ca4cf05147d86d6eff56ccafdd09d0_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_c0ec47abc53a2509e744dad22ccf8191 @x2 @x3) @x1) (BoxBool_proj_0 (Prims.op_LessThan @x1 @x2))) :pattern ((select (Tm_refine_pred_c0ec47abc53a2509e744dad22ccf8191 @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_c0ec47abc53a2509e744dad22ccf8191_sel)) :named ho_refinement_interpretation_Tm_refine_c0ec47abc53a2509e744dad22ccf8191_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_c1424615841f28cac7fc34e92b7ff33c @x2) @x1) (< (BoxInt_proj_0 @x1) (BoxInt_proj_0 @x2))) :pattern ((select (Tm_refine_pred_c1424615841f28cac7fc34e92b7ff33c @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c_sel)) :named ho_refinement_interpretation_Tm_refine_c1424615841f28cac7fc34e92b7ff33c_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_d5743ca0a8d5f3ceec748bdcb132b14f @x2) @x1) (= (FStar.UInt.lognot (BoxInt 32) (FStar.UInt32.v @x2)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_d5743ca0a8d5f3ceec748bdcb132b14f @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_d5743ca0a8d5f3ceec748bdcb132b14f_sel)) :named ho_refinement_interpretation_Tm_refine_d5743ca0a8d5f3ceec748bdcb132b14f_sel))


(assert (! (forall ((@x1 Term) (@x2 Term) (@x3 Term)) (! (iff (select (Tm_refine_pred_edc8fb7e909853d860d4ab445ef31337 @x2 @x3) @x1) (= (FStar.UInt.add_mod (BoxInt 32) (FStar.UInt32.v @x2) (FStar.UInt32.v @x3)) (FStar.UInt32.v @x1))) :pattern ((select (Tm_refine_pred_edc8fb7e909853d860d4ab445ef31337 @x2 @x3) @x1)) :qid ho_refinement_interpretation_Tm_refine_edc8fb7e909853d860d4ab445ef31337_sel)) :named ho_refinement_interpretation_Tm_refine_edc8fb7e909853d860d4ab445ef31337_sel))


(assert (! (forall ((@x1 Term) (@x2 Term)) (! (iff (select (Tm_refine_pred_f13070840248fced9d9d60d77bdae3ec @x2) @x1) (Valid (FStar.UInt.size @x1 @x2))) :pattern ((select (Tm_refine_pred_f13070840248fced9d9d60d77bdae3ec @x2) @x1)) :qid ho_refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec_sel)) :named ho_refinement_interpretation_Tm_refine_f13070840248fced9d9d60d77bdae3ec_sel))
