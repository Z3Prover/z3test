; FP(2,8) positive overflow selects infinity or max finite by rounding mode.
(set-logic QF_FP)
...
(define-fun bad-all-modes ((x FP28) (y FP28)) Bool
  (or
    ...
    (bad-div RTP x y (_ +oo 2 8))
    (bad-div RTN x y (fp #b0 #b10 #b1111111))
    (bad-div RTZ x y (fp #b0 #b10 #b1111111))))
(declare-fun denominator () FP28)
(assert (and
  (fp.eq denominator (fp #b0 #b00 #b0000001))
  (bad-all-modes (fp #b0 #b10 #b1111111) denominator)))
