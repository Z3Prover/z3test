...
(push 1)
(assert (and
  (fp.eq x43 p-min-sub-43)
  (fp.eq y43 p-min-sub-43)
...
(push 1)
(assert (and
  (fp.eq x133 (fp #b0 #b0111111111111 #b00))
  (fp.eq y133 (fp #b0 #b0111111111111 #b00))
  (not (= (fp.div RNE x133 y133) (fp #b0 #b0111111111111 #b00)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x133 (fp #b0 #b1111111111110 #b11))
  (fp.eq y133 (fp #b0 #b0000000000000 #b01))
  (not (= (fp.div RTZ x133 y133) (fp #b0 #b1111111111110 #b11)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x133 (fp #b0 #b0000000000000 #b01))
  (fp.eq y133 (fp #b0 #b1111111111110 #b11))
...
(push 1)
(assert (and
  (fp.eq x123 (fp #b0 #b011111111111 #b00))
...
(push 1)
(assert (and (fp.isNaN x43) (fp.eq y43 p-one-43)
  (not (fp.isNaN (fp.div RNE x43 y43)))))
(check-sat)
(pop 1)
(push 1)
(assert (and (fp.eq x43 p-one-43) (fp.isNaN y43)
  (not (fp.isNaN (fp.div RNE x43 y43)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.isInfinite x43) (fp.isPositive x43)
  (fp.isInfinite y43) (fp.isNegative y43)
  (not (fp.isNaN (fp.div RNE x43 y43)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x43 p-one-43) (fp.isInfinite y43) (fp.isPositive y43)
  (not (= (fp.div RNE x43 y43) (_ +zero 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x43 p-one-43) (fp.isInfinite y43) (fp.isNegative y43)
  (not (= (fp.div RNE x43 y43) (_ -zero 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x43 p-one-43) (fp.isZero y43) (fp.isPositive y43)
  (not (= (fp.div RNE x43 y43) (_ +oo 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.eq x43 p-one-43) (fp.isZero y43) (fp.isNegative y43)
  (not (= (fp.div RNE x43 y43) (_ -oo 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.isZero x43) (fp.isPositive x43) (fp.eq y43 p-one-43)
  (not (= (fp.div RNE x43 y43) (_ +zero 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.isZero x43) (fp.isNegative x43) (fp.eq y43 p-one-43)
  (not (= (fp.div RNE x43 y43) (_ -zero 4 3)))))
(check-sat)
(pop 1)
(push 1)
(assert (and
  (fp.isZero x43) (fp.isPositive x43)
  (fp.isZero y43) (fp.isNegative y43)
  (not (fp.isNaN (fp.div RNE x43 y43)))))
(check-sat)
(pop 1)
