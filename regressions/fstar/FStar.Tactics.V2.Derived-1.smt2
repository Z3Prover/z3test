...
;   forall (p: (_: Prims.list a -> Prims.prop)).
;     (forall (r: Prims.list a). p r) ==>
;     (forall (k: (_: Prims.list a -> Prims.prop)).
;         (forall (r: Prims.list a). {:pattern Prims.guard_free (k r)} k r) ==>
;         (forall (r: FStar.Pervasives.either Prims.exn a) (k: (_: Prims.list a -> Prims.prop)).
;             (forall (r: Prims.list a). {:pattern Prims.guard_free (k r)} k r) ==>
;             ~(Inl? r) /\ ~(Inr? r) ==> Prims.l_False))
      ...
      (forall ((@x2 Term))
       (! (implies
         (and
          ...
          (forall ((@x3 Term))
           (! (implies
             (or label_1 (HasType @x3 (Prims.list uu___334 @x0)))
         ...
         (forall ((@x3 Term))
          (! (implies
            (and
             (HasType @x3 (Tm_arrow_a1c23f05d4ee72892690ac239bf26df3 uu___334 @x0))
             ...
             (forall ((@x4 Term))
              (! ;; def=FStar.Tactics.Effect.fsti(56,79-56,82); use=FStar.Tactics.V2.Derived.fst(483,4-485,28)
               ...
               :qid @query.4)))
            ;; def=FStar.Tactics.Effect.fsti(117,31-117,61); use=FStar.Tactics.V2.Derived.fst(483,10-483,15)
            (forall ((@x4 Term))
             (! (implies
               (HasType @x4 (FStar.Pervasives.either U_zero uu___334 Prims.exn @x0))
               (forall ((@x5 Term))
                (! (implies
                  (and
                   (HasType @x5 (Tm_arrow_a1c23f05d4ee72892690ac239bf26df3 uu___334 @x0))
                   ;; def=FStar.Tactics.Effect.fsti(56,24-56,83); use=FStar.Tactics.V2.Derived.fst(483,4-485,28)
                   (forall ((@x6 Term))
                    (! ;; def=FStar.Tactics.Effect.fsti(56,79-56,82); use=FStar.Tactics.V2.Derived.fst(483,4-485,28)
                     (Valid
                   ...
                   (not
                    ;; def=FStar.Tactics.V2.Derived.fst(483,10-483,17); use=FStar.Tactics.V2.Derived.fst(483,10-483,17)
                    (BoxBool_proj_0 (FStar.Pervasives.uu___is_Inl U_zero uu___334 Prims.exn @x0 @x4)))
                   ;; def=FStar.Tactics.V2.Derived.fst(483,10-483,17); use=FStar.Tactics.V2.Derived.fst(483,10-483,17)
                   (not
                    ;; def=FStar.Tactics.V2.Derived.fst(483,10-483,17); use=FStar.Tactics.V2.Derived.fst(483,10-483,17)
                    (BoxBool_proj_0 (FStar.Pervasives.uu___is_Inr U_zero uu___334 Prims.exn @x0 @x4))))
                  label_2)
                 :qid @query.6)))
              :qid @query.5)))
           :qid @query.3)))
