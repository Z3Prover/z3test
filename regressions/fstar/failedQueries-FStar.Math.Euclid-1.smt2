...
; Encoding query formula : forall (a: Prims.int) (b: Prims.int).
;   (* - Could not prove post-condition *)
;   forall (p: Prims.pure_post (Prims.int & Prims.int & Prims.int)).
;     (forall (pure_result: Prims.int & Prims.int & Prims.int).
;         (let r, s, d = pure_result in
;           r * a + s * b = d /\ FStar.Math.Euclid.is_gcd a b d) ==>
;         p pure_result) ==>
;     (forall (k: Prims.pure_post (Prims.int & Prims.int & Prims.int)).
;         (forall (x: Prims.int & Prims.int & Prims.int). {:pattern Prims.guard_free (k x)}
;             (x ==
;               (match b >= 0 with
...
;               (forall (return_val: Prims.int & Prims.int & Prims.int).
;                   return_val == x ==> p return_val)) ==>
;             k x) ==>
;         (b >= 0 == true ==>
;           b >= 0 /\ 1 * a + 0 * b = a /\ 0 * a + 1 * b = b /\
;           (forall (pure_result: Prims.int & Prims.int & Prims.int).
;               (let u1818, v, d = pure_result in
;                 u1818 * a + v * b = d /\ FStar.Math.Euclid.is_gcd a b d) ==>
;               k pure_result)) /\
;         (~(b >= 0 = true) ==>
;           (forall (b: Prims.bool).
;               b >= 0 == b ==>
;               (forall (d: Prims.int).
;                   (* - Could not prove post-condition *)
;                   forall (_pf: Prims.squash (FStar.Math.Euclid.is_gcd a (- b) d)).
;                     (* - Could not prove post-condition *) FStar.Math.Euclid.is_gcd a (- b) d) /\
;               (forall (any_result:
;                   (x: Prims.int
;                       -> Prims.squash (FStar.Math.Euclid.is_gcd a (- b) x ==>
;                             FStar.Math.Euclid.is_gcd a b x)))
;                   (any_result:
...
;                   - b >= 0 /\ 1 * a + 0 * b = a /\ 0 * a + -1 * b = - b /\
;                   (forall (d: Prims.int).
;                       FStar.Math.Euclid.is_gcd a (- b) d ==> FStar.Math.Euclid.is_gcd a b d) /\
;                   (forall (pure_result: Prims.int & Prims.int & Prims.int).
;                       (let u1832, v, d = pure_result in
;                         u1832 * a + v * b = d /\ FStar.Math.Euclid.is_gcd a b d) ==>
;                       FStar.Math.Euclid.egcd a b 1 0 a 0 -1 (- b) == pure_result ==>
;                       (forall (b: Prims.int & Prims.int & Prims.int).
;                           pure_result == b ==>
;                           (forall (b: Prims.int) (b: Prims.int) (b: Prims.int).
;                               b == (b, b, b) ==>
;                               FStar.Math.Euclid.is_gcd a b b /\
;                               (forall (pure_result: Prims.unit).
;                                   FStar.Math.Euclid.is_gcd a b b ==>
;                                   (forall (any_result: Prims.int & Prims.int & Prims.int).
;                                       k any_result)))))))))
              ...
              (let ((@lb4 @x3))
               ...
               (and
                ...
                (or
                 ...
                 (=
                  (Prims.op_Addition
                   (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_1 @lb4) @x0)
                   (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_2 @lb4) @x1))
                  (FStar.Pervasives.Native.Mktuple3_@_3 @lb4)))
                ...
                (or
                 ...
                 (Valid
                  ;; def=FStar.Math.Euclid.fsti(98,50-98,62); use=FStar.Math.Euclid.fst(192,2-204,3)
                  (FStar.Math.Euclid.is_gcd @x0 @x1 (FStar.Pervasives.Native.Mktuple3_@_3 @lb4)))))))
            ...
            :pattern
             (;; def=Prims.fst(409,83-409,96); use=FStar.Math.Euclid.fst(192,2-204,3)
              (Valid
               ...
               (ApplyTT @x2 @x3)))
            :qid @query.2)))
         ;; def=Prims.fst(368,4-368,99); use=FStar.Math.Euclid.fst(192,2-204,3)
         (forall ((@x3 Term))
          (! (implies
            (and
             (HasType
             ...
             (forall ((@x4 Term))
              (! (implies
                (implies
                 ...
                 (=
                  @x4
                  (let ((@lb5 (Prims.op_GreaterThanOrEqual @x1 (BoxInt 0))))
                   (ite
                    (= @lb5 (BoxBool true))
               ...
               :qid @query.4)))
            ;; def=Prims.fst(355,2-355,39); use=FStar.Math.Euclid.fst(192,2-204,3)
            (and
             (implies
              ;; def=FStar.Math.Euclid.fst(192,5-192,11); use=FStar.Math.Euclid.fst(192,5-192,11)
              (= (Prims.op_GreaterThanOrEqual @x1 (BoxInt 0)) (BoxBool true))
              ;; def=Prims.fst(409,29-409,97); use=FStar.Math.Euclid.fst(193,4-193,8)
              (and
               ;; def=FStar.Math.Euclid.fst(145,12-145,19); use=FStar.Math.Euclid.fst(193,4-193,8)
               (or
                label_4
                ;; def=FStar.Math.Euclid.fst(145,12-145,19); use=FStar.Math.Euclid.fst(193,4-193,8)
                (>= (BoxInt_proj_0 @x1) (BoxInt_proj_0 (BoxInt 0))))
               ;; def=FStar.Math.Euclid.fst(146,12-146,32); use=FStar.Math.Euclid.fst(193,4-193,8)
               (or
                label_5
                ;; def=FStar.Math.Euclid.fst(146,12-146,32); use=FStar.Math.Euclid.fst(193,4-193,8)
                (=
                 (Prims.op_Addition (Prims.op_Star (BoxInt 1) @x0) (Prims.op_Star (BoxInt 0) @x1))
                 @x0))
               ;; def=FStar.Math.Euclid.fst(147,12-147,32); use=FStar.Math.Euclid.fst(193,4-193,8)
               (or
                label_6
                ;; def=FStar.Math.Euclid.fst(147,12-147,32); use=FStar.Math.Euclid.fst(193,4-193,8)
                (=
                 ...
                 @x1))
               ;; def=Prims.fst(409,36-409,97); use=FStar.Math.Euclid.fst(193,4-193,8)
               (forall ((@x4 Term))
                (! (implies
                  (and
                   (HasType
                    ...
                    (FStar.Pervasives.Native.tuple3
                     ...
                     Prims.int))
                   (let ((@lb5 @x4))
                    ;; def=FStar.Math.Euclid.fst(149,29-149,62); use=FStar.Math.Euclid.fst(193,4-193,8)
                    (and
                     ;; def=FStar.Math.Euclid.fst(149,29-149,46); use=FStar.Math.Euclid.fst(193,4-193,8)
                     (=
                      (Prims.op_Addition
                       (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_1 @lb5) @x0)
                       (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_2 @lb5) @x1))
                      (FStar.Pervasives.Native.Mktuple3_@_3 @lb5))
                     ;; def=FStar.Math.Euclid.fst(149,50-149,62); use=FStar.Math.Euclid.fst(193,4-193,8)
                     (Valid
                      ;; def=FStar.Math.Euclid.fst(149,50-149,62); use=FStar.Math.Euclid.fst(193,4-193,8)
                      (FStar.Math.Euclid.is_gcd @x0 @x1 (FStar.Pervasives.Native.Mktuple3_@_3 @lb5))))))
                  ;; def=Prims.fst(409,83-409,96); use=FStar.Math.Euclid.fst(193,4-193,8)
                  (Valid
                   ;; def=Prims.fst(409,83-409,96); use=FStar.Math.Euclid.fst(193,4-193,8)
                   (ApplyTT @x3 @x4)))
                 :qid @query.6))))
             (implies
              ...
              (not
               ;; def=FStar.Math.Euclid.fst(192,5-192,11); use=FStar.Math.Euclid.fst(192,5-192,11)
               (= (Prims.op_GreaterThanOrEqual @x1 (BoxInt 0)) (BoxBool true)))
              ;; def=Prims.fst(381,28-381,49); use=FStar.Math.Euclid.fst(192,2-204,3)
              (forall ((@x4 Term))
               (! (implies
                 (and
                  (HasType @x4 Prims.bool)
                  ;; def=FStar.Math.Euclid.fst(192,5-204,3); use=FStar.Math.Euclid.fst(192,5-204,3)
                  (= (Prims.op_GreaterThanOrEqual @x1 (BoxInt 0)) @x4))
                 ;; def=Prims.fst(427,77-427,89); use=FStar.Math.Euclid.fst(192,2-204,3)
                 (and
                  ;; def=FStar.Math.Euclid.fst(192,2-204,3); use=FStar.Math.Euclid.fst(192,2-204,3)
                  (forall ((@x5 Term))
                   (! (implies
                     (HasType @x5 Prims.int)
                     ;; def=FStar.Math.Euclid.fst(196,9-199,35); use=FStar.Math.Euclid.fst(196,9-199,35)
                     (forall ((@x6 Term))
                      (! (implies
                        (HasType
                         @x6
                         (Prims.squash (FStar.Math.Euclid.is_gcd @x0 (Prims.op_Minus @x1) @x5)))
                        ;; def=FStar.Math.Euclid.fsti(78,12-78,27); use=FStar.Math.Euclid.fst(198,12-198,24)
                        (or
                         label_7
                         ;; def=FStar.Math.Euclid.fsti(78,12-78,27); use=FStar.Math.Euclid.fst(198,12-198,24)
                         (Valid
                          ;; def=FStar.Math.Euclid.fsti(78,12-78,27); use=FStar.Math.Euclid.fst(198,12-198,24)
                          (FStar.Math.Euclid.is_gcd @x0 (Prims.op_Minus @x1) @x5))))
                       :qid @query.9)))
                    :qid @query.8))
                  ;; def=Prims.fst(419,66-419,102); use=FStar.Math.Euclid.fst(192,2-204,3)
                  (forall ((@x5 Term))
                   (! (implies
                     (HasType @x5 (Tm_arrow_9ee503e088bd858875d95fd61473a29f @x0 @x1))
                     ;; def=Prims.fst(419,66-419,102); use=FStar.Math.Euclid.fst(192,2-204,3)
                     (forall ((@x6 Term))
                      (! (implies
                        (HasType @x6 (Tm_refine_760c5e70adce122a95cd106d0e0c6598 @x0 @x1))
                        ;; def=Prims.fst(419,66-419,102); use=FStar.Math.Euclid.fst(192,2-204,3)
                        (forall ((@x7 Term))
                         (! (implies
                           (HasType @x7 (Tm_refine_760c5e70adce122a95cd106d0e0c6598 @x0 @x1))
                           ;; def=Prims.fst(409,29-409,97); use=FStar.Math.Euclid.fst(200,14-200,18)
                           (and
                            ;; def=FStar.Math.Euclid.fst(145,12-145,19); use=FStar.Math.Euclid.fst(200,14-200,18)
                            (or
                             label_8
                             ;; def=FStar.Math.Euclid.fst(145,12-145,19); use=FStar.Math.Euclid.fst(200,14-200,18)
                             (>= (BoxInt_proj_0 (Prims.op_Minus @x1)) (BoxInt_proj_0 (BoxInt 0))))
                            ;; def=FStar.Math.Euclid.fst(146,12-146,32); use=FStar.Math.Euclid.fst(200,14-200,18)
                            (or
                             label_9
                             ;; def=FStar.Math.Euclid.fst(146,12-146,32); use=FStar.Math.Euclid.fst(200,14-200,18)
                             (=
                              (Prims.op_Addition
                               (Prims.op_Star (BoxInt 1) @x0)
                               (Prims.op_Star (BoxInt 0) @x1))
                              @x0))
                            ...
                            (or
                             ...
                             (=
                              (Prims.op_Addition
                               (Prims.op_Star (BoxInt 0) @x0)
                               (Prims.op_Star (BoxInt -1) @x1))
                              (Prims.op_Minus @x1)))
                            ;; def=FStar.Math.Euclid.fst(148,12-148,55); use=FStar.Math.Euclid.fst(200,14-200,18)
                            (forall ((@x8 Term))
                             (! (implies
                               (and
                                (HasType @x8 Prims.int)
                                ;; def=FStar.Math.Euclid.fst(148,23-148,37); use=FStar.Math.Euclid.fst(200,14-200,18)
                                (Valid
                                 ;; def=FStar.Math.Euclid.fst(148,23-148,37); use=FStar.Math.Euclid.fst(200,14-200,18)
                                 (FStar.Math.Euclid.is_gcd @x0 (Prims.op_Minus @x1) @x8)))
                               ;; def=FStar.Math.Euclid.fst(148,42-148,54); use=FStar.Math.Euclid.fst(200,14-200,18)
                               (or
                                label_11
                                ;; def=FStar.Math.Euclid.fst(148,42-148,54); use=FStar.Math.Euclid.fst(200,14-200,18)
                                (Valid
                                 ...
                                 (FStar.Math.Euclid.is_gcd @x0 @x1 @x8))))
                              :qid @query.13))
                            ;; def=Prims.fst(409,36-409,97); use=FStar.Math.Euclid.fst(200,14-200,18)
                            (forall ((@x8 Term))
                             (! (implies
                               (and
                                (HasType
                                 ...
                                 (FStar.Pervasives.Native.tuple3
                                  ...
                                  Prims.int))
                                (let ((@lb9 @x8))
                                 ;; def=FStar.Math.Euclid.fst(149,29-149,62); use=FStar.Math.Euclid.fst(200,14-200,18)
                                 (and
                                  ;; def=FStar.Math.Euclid.fst(149,29-149,46); use=FStar.Math.Euclid.fst(200,14-200,18)
                                  (=
                                   (Prims.op_Addition
                                    (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_1 @lb9) @x0)
                                    (Prims.op_Star (FStar.Pervasives.Native.Mktuple3_@_2 @lb9) @x1))
                                   (FStar.Pervasives.Native.Mktuple3_@_3 @lb9))
                                  ;; def=FStar.Math.Euclid.fst(149,50-149,62); use=FStar.Math.Euclid.fst(200,14-200,18)
                                  (Valid
                                   ;; def=FStar.Math.Euclid.fst(149,50-149,62); use=FStar.Math.Euclid.fst(200,14-200,18)
                                   (FStar.Math.Euclid.is_gcd
                                    ...
                                    @x1
                                    (FStar.Pervasives.Native.Mktuple3_@_3 @lb9)))))
                                ;; def=FStar.Math.Euclid.fst(200,8-200,40); use=FStar.Math.Euclid.fst(200,8-200,40)
                                (=
                                 (FStar.Math.Euclid.egcd
                                  @x0
                                  @x1
                                  ...
                                  (and
                                   (HasType
                                    ...
                                    (FStar.Pervasives.Native.tuple3
                                     ...
                                     Prims.int
                                     Prims.int))
                                   ;; def=FStar.Math.Euclid.fst(200,8-201,15); use=FStar.Math.Euclid.fst(201,8-201,21)
                                   (= @x8 @x9))
                                  ;; def=Prims.fst(381,28-381,49); use=FStar.Math.Euclid.fst(192,2-204,3)
                                  (forall ((@x10 Term))
                                   (! (implies
                                     (HasType @x10 Prims.int)
                                     ;; def=Prims.fst(381,28-381,49); use=FStar.Math.Euclid.fst(192,2-204,3)
                                     (forall ((@x11 Term))
                                      (! (implies
                                        (HasType @x11 Prims.int)
                                        ;; def=Prims.fst(381,28-381,49); use=FStar.Math.Euclid.fst(192,2-204,3)
                                        (forall ((@x12 Term))
                                         (! (implies
                                           (and
                                            (HasType @x12 Prims.int)
                                            ;; def=FStar.Math.Euclid.fst(201,8-201,15); use=FStar.Math.Euclid.fst(201,8-201,15)
                                            (=
                                             @x9
                                             (FStar.Pervasives.Native.Mktuple3
                                              U_zero
                                              ...
                                              @x11
                                              @x12)))
                                           ;; def=Prims.fst(409,29-409,97); use=FStar.Math.Euclid.fst(202,4-202,10)
                                           (and
                                            ;; def=FStar.Math.Euclid.fst(202,11-202,25); use=FStar.Math.Euclid.fst(202,4-202,10)
                                            (or
                                             label_12
                                             ;; def=FStar.Math.Euclid.fst(202,11-202,25); use=FStar.Math.Euclid.fst(202,4-202,10)
                                             (Valid
                                              ;; def=FStar.Math.Euclid.fst(202,11-202,25); use=FStar.Math.Euclid.fst(202,4-202,10)
                                              (FStar.Math.Euclid.is_gcd @x0 @x1 @x12)))
                                            ;; def=Prims.fst(409,36-409,97); use=FStar.Math.Euclid.fst(202,4-202,10)
                                            (forall ((@x13 Term))
                                             (! (implies
                                               (and
                                                ...
                                                (! (implies
                                                  (HasType
                                                   ...
                                                   (FStar.Pervasives.Native.tuple3
                                                    ...
                                                    Prims.int
                                                    Prims.int))
                                                  ;; def=Prims.fst(419,90-419,102); use=FStar.Math.Euclid.fst(192,2-204,3)
                                                  (Valid
                                                   ;; def=Prims.fst(419,90-419,102); use=FStar.Math.Euclid.fst(192,2-204,3)
                                                   (ApplyTT @x3 @x14)))
                                                 :qid @query.20)))
