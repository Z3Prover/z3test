...
(declare-fun %lbl%+12123 () Bool)
(declare-fun %lbl%+12559 () Bool)
...
(push 1)
(set-info :boogie-vc-id bartokProofs)
(assert (not
(let ((infloop_correct (=> (! (and %lbl%+12123 true) :lblpos +12123) true)))
(let ((PreconditionGeneratedEntry_correct (=> (! (and %lbl%+12559 true) :lblpos +12559) infloop_correct)))
